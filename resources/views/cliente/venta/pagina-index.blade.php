<x-cliente-layout>
    ...
    ?>
    @section('tituloPagina', 'Mis pedidos' . $titulo)

    <!--SEO-->
    @section('tituloPagina', 'Mis pedidos')
    @section('descripcion', 'En ' . env('APP_NAME') . ' puedes gestionar tus pedidos.')

    <!--CONTENEDOR PAGINA CLIENTE-->
    <div class="contenedor_pagina_cliente">

        <!--TITULO-->
        <h2 class="cliente_paginas_titulo">Mis pedidos</h2>
                        ...
                        @foreach ($ventas as $venta)
                            <li style="border: 1px solid #ccc; border-radius: 5px; margin: 10px 0px;">
                                ...
                                <div class="flex items-center py-2 px-4">
                                    ...
                                    @endphp
                                    <img width="50px" src="{{ $primerProducto['options']['imagen'] }}"
                                        alt="">
