<x-cliente-layout>
    ...
    @section('descripcion', 'En ' . env('APP_NAME') . ' puedes tener muchos cupones para aplicarlos en tu compra y así
        tener grandes descuentos.')

        <!--CONTENEDOR PAGINA PERFIL-->
        <div class="contenedor_pagina_cliente">

            <!--TITULO-->
            <h2 class="cliente_paginas_titulo">Mis cupones</h2>
