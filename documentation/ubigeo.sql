...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2022 a las 17:41:29
...
CREATE TABLE `departamentos` (
  `idDepartamento` int(11) NOT NULL COMMENT 'id unico',
...
CREATE TABLE `pais` (
  `idPais` int(11) NOT NULL COMMENT 'id unico de pais',
...
ALTER TABLE `distrito`
  ...
  ADD KEY `idProvincia1` (`idProvincia`);
...
ALTER TABLE `provincia`
  ...
  ADD KEY `idDepartamento1` (`idDepartamento`);
...
--
ALTER TABLE `departamentos`
  MODIFY `idDepartamento` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id unico', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `pais`
--
ALTER TABLE `pais`
  MODIFY `idPais` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id unico de pais', AUTO_INCREMENT=2;
...
--
ALTER TABLE `departamentos`
  ADD CONSTRAINT `Pais.Departamento` FOREIGN KEY (`idPais`) REFERENCES `pais` (`idPais`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `distrito`
--
ALTER TABLE `distrito`
  ADD CONSTRAINT `Provincia.Distrito` FOREIGN KEY (`idProvincia`) REFERENCES `provincia` (`idProvincia`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `Provincia.Departamento` FOREIGN KEY (`idDepartamento`) REFERENCES `departamentos` (`idDepartamento`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
